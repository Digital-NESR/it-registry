"use client";
// @ds-adherence-ignore -- starter scaffold (raw elements/hex/px by design)
/* Reusable Tweaks shell + form-control helpers. Ported from the prototype's
   tweaks-panel.jsx. The panel stays hidden unless an embedding host activates
   edit mode via postMessage, so it has no effect in normal use. */
