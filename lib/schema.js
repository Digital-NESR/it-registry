...
export const domains = [
  { key: "identity", label: "Identity & Ownership", icon: "id", fields: [
    ...
    { key: "itOwner", label: "IT Owner / Manager", people: true, hint: "IT person responsible for running and supporting the application." },
    { key: "department", label: "Department", ref: "department", hint: "Owning business department." },
    { key: "costCentre", label: "Cost Centre", ref: "costCentre", hint: "Cost centre the application's spend is booked against." },
  ...
  { key: "technical", label: "Technical Profile", icon: "chip", fields: [
    ...
    { key: "architectureType", label: "Architecture Type", ref: "architectureType", hint: "Overall architecture pattern." },
